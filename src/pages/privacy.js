  ...
  <div>
    ...
    <div className="terms-container">
      ...
      <div className="terms-text">
        ...
        <p>Using the LinkLater App and participating in the program may involve the collection and use of data by LinkLater as outlined below. Capitalized terms have the meaning assigned to them in the Terms above. </p>
